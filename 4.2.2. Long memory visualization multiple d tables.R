...
par(mar = c(6, 5.5, 2, 7), xpd = TRUE)
row_colors <- rainbow(nrow(own_times_farima_matrix))
matplot(t(own_times_farima_matrix), ylim=c(0,max(r_times_matrix)),type = "l", col = row_colors, lty = 1,lwd = 1.5, xlab = "T", ylab = "Average running time", cex.lab = lab_size, cex.axis = axis_text, labels = FALSE)
mtext(TeX(main), side = 3, line = -1, outer = TRUE, cex=tite_size, font = 2)
axis(1, at=1:8, labels = names)
axis(2)
legend("topright", inset = c(-0.4, 0), legend = c(0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45),
...
par(mar = c(6, 5.5, 2, 7), xpd = TRUE)
row_colors <- rainbow(nrow(own_average_farima_matrix))
matplot(t(own_average_farima_matrix), ylim=c(0,max(r_average_matrix)),type = "l", col = row_colors, lty = 1,lwd = 1.5, xlab = "T", ylab = TeX("$\\bar{\\hat{\\mu}}$"), cex.lab = lab_size, cex.axis = axis_text, labels = FALSE)
mtext(TeX(main), side = 3, line = -1, outer = TRUE, cex=tite_size, font = 2)
axis(1, at=1:8, labels = names)
axis(2)
legend("topright", inset = c(-0.4, 0), legend = c(0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45),
...
# PLOT
par(mar = c(5.5, 5.5, 2, 7), xpd = TRUE)
row_colors <- rainbow(nrow(own_long_param_farima_matrix))
matplot(t(own_long_param_farima_matrix), ylim=c(0,max(own_long_param_farima_matrix)),type = "l", col = row_colors, lty = 1,lwd = 1.5, xlab = "T", ylab = TeX("$MSE(\\bar{\\hat{d}},d)$"), cex.lab = lab_size, cex.axis = axis_text, labels = FALSE)
mtext(TeX(main), side = 3, line = -1, outer = TRUE, cex=tite_size, font = 2)
axis(1, at=1:8, labels = names)
axis(2)
legend("topright", inset = c(-0.4, 0), legend = c(0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45),
...
par(mar = c(6, 5.5, 2, 7), xpd = TRUE)
row_colors <- rainbow(nrow(own_lambda_farima_matrix))
matplot(t(own_lambda_farima_matrix), ylim=c(0,max(own_lambda_farima_matrix)),type = "l", col = row_colors, lty = 1,lwd = 1.5, xlab = "T", ylab = TeX("$MSE(\\hat{\\lambda},\\lambda)$"), cex.lab = lab_size, cex.axis = axis_text, labels = FALSE)
mtext(TeX(main), side = 3, line = -1, outer = TRUE, cex=tite_size, font = 2)
axis(1, at=1:8, labels = names)
axis(2)
legend("topright", inset = c(-0.4, 0), legend = c(0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45),
...
par(mar = c(6, 5.5, 2, 7), xpd = TRUE)
row_colors <- rainbow(nrow(own_exp_1_farima_matrix))
matplot(t(own_exp_1_farima_matrix), ylim=c(0,max(own_exp_1_farima_matrix)),type = "l", col = row_colors, lty = 1,lwd = 1.5, xlab = "T", ylab = TeX(paste0("No rejected $H_0$, (%)")), cex.lab = lab_size, cex.axis = axis_text, labels = FALSE)
mtext(TeX(main), side = 3, line = -1, outer = TRUE, cex=tite_size, font = 2)
axis(1, at=1:8, labels = names)
axis(2)
legend("topright", inset = c(-0.4, 0), legend = c(0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45),
