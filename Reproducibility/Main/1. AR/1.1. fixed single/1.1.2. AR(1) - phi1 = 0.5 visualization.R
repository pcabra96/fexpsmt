...
# 5.4. MSE FOR LAMBDA COEFFICIENT, FREQUENCY DOMAIN (Figures: 7,8)
# 5.5. FREQUENCY DOMAIN GOODNESS OF FIT, FREQUENCY DOMAIN (Figures: 9,10)
...
path = paste0("~/Documents/2. UNIGE/2023-1 Master Thesis/fexpsmt/Reproducibility/Main/1. ",PROCESS,"/1.1. ",SUB_PROCESS,"/")
ar_coef_vec = 0.5 #readRDS(file = paste0(path,"ar_coef_vec.RData"))
...
process_string = paste0(PROCESS,"(phi_1=",ar_coef_vec,")")
