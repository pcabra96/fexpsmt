...
# SIMPLE TEST TO COMPARE DATA FROM OWN PACKAGE VS STATS PACKAGE
t.test(time_own[,1],time_r[,1]) # 2^7
t.test(time_own[,2],time_r[,2]) # 2^8
t.test(time_own[,3],time_r[,3]) # 2^9
t.test(time_own[,4],time_r[,4]) # 2^10
t.test(time_own[,5],time_r[,5]) # 2^11
t.test(time_own[,6],time_r[,6]) # 2^12
t.test(time_own[,7],time_r[,7]) # 2^13
t.test(time_own[,8],time_r[,8]) # 2^14
