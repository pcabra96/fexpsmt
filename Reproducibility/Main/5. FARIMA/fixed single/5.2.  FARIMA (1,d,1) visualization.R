...
par(mfrow=c(1,2))
boxplot(time_own, ylim=c(lim_inf,lim_sup), names = names, ylab = "time (s)", xlab = "T")
title(main = "fexpmst", cex.main = 0.8, line = 0.5)
boxplot(time_r, ylim = c(lim_inf,lim_sup), names = names, ylab = "time (s)", xlab = "T")
title(main = "fracdiff", cex.main = 0.8, line = 0.5)
...
par(mfrow=c(1,1))
plot(x = POWER, y = colMeans(time_own), col = "blue", type = "o", ylim=c(lim_inf,lim_sup), ylab = "time (s)", labels = FALSE, xlab = "T")
lines(x = POWER, y = colMeans(time_r), col = "red", type = "o")
axis(1, at=POWER, labels = names)
axis(2)
legend("topleft", legend = c("fepxmst", "fracdiff"), col = c("blue", "red"), lty = 1)
...
legend("topright", legend = c("fepxmst", "fracdiff"), col = c("blue", "red"), lty = 1)
...
par(mfrow = c(1, 1), mar=c(5,5,3,2)) # mar = c(bottom, left, top, right))
plot(x = POWER, y = mean_d_mse_own, col = "blue", type = "o", ylab = TeX("$\\hat{d}$ $MSE"), labels = FALSE, xlab = "T",ylim = c(min_lim, max_lim))
